...
public partial class Construccionesvista19
{
    ...
    public float? Valorconservacion { get; set; }

    public string? Nombreuso { get; set; }

    public float? Valoruso { get; set; }

    public string? Nombrerevestimieto { get; set; }

    public string? Tipoconstruccion { get; set; }

    public float? Valortipoconstruccion { get; set; }
}
