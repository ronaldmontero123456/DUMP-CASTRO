...
public partial class Terrenos19
{
    ...
    public virtual Forma? FormaNavigation { get; set; }

    public virtual MaterialVium? MaterialViaNavigation { get; set; }

    public virtual Otcatastro? Otcatastro { get; set; }

    public virtual Topografium? TopografiaNavigation { get; set; }

    public virtual Ubicacion? UbicacionNavigation { get; set; }

    public virtual TipoVium? ViaNavigation { get; set; }
